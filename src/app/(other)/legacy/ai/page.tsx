...
import { ToolRenderer } from '@/features/(legacy)/ai/components/ai-tools/registry'
import { Streamdown } from 'streamdown'
import { code } from '@streamdown/code'
import { useCallback, useEffect, useMemo, useRef, useState } from 'react'
import { CubeIcon, GearFineIcon, PencilCircleIcon, SparkleIcon } from '@phosphor-icons/react'
import { Fragment } from 'react'
import { AICofounderInput } from '@/features/(legacy)/ai/components/ai-input'
  ...
  const suggestions = useMemo(
    () => [
      ...
      },
      {
        ...
        description: 'Rewrite thist feature to convert better.',
            ...
            <div className="flex flex-col items-center gap-4 mt-10">
              ...
              <div className="grid w-full max-w-3xl gap-2 sm:grid-cols-3">
                {suggestions.map((suggestion) => {
                  ...
                  const isSuggestionDisabled = isLoading
