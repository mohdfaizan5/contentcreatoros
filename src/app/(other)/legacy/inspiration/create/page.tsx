...
import { ArrowLeft, Link as LinkIcon, SpinnerGap, TwitterLogo, LinkedinLogo, YoutubeLogo, InstagramLogo } from '@phosphor-icons/react';
import Link from 'next/link';
import { Button } from '@/shared/components/ui/button';
import { AutoResizeTextarea } from '@/shared/components/ui/auto-resize-textarea';
import { createInspiration } from '@/features/inspiration/actions/inspiration';
import { detectUrlInfo, extractTweetId, getPlatformColors, getPlatformLabel } from '@/features/inspiration/lib/url-detector';
import { buildAppPath, LEGACY_APP_ROOT } from '@/features/inspiration/lib/app-shell';
import type { InspirationType } from '@/shared/types/database';
...
export default function CreateInspirationPage() {
    ...
    const handleSubmit = () => {
        ...
        startTransition(async () => {
            try {
                ...
                router.push(buildAppPath(LEGACY_APP_ROOT, '/inspiration'));
            } catch (error) {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 animate-fade-in-up">
            {/* Back navigation */}
            <Link
                href={buildAppPath(LEGACY_APP_ROOT, '/inspiration')}
