...
import Editor from '@/features/(legacy)/editor/editor';
import { updateIdea, deleteIdea } from '@/features/(legacy)/ideas/actions/ideas';
import { createContentFromIdea } from '@/features/(legacy)/planning/actions/planning';
import type { Idea, EditorJSData } from '@/shared/types/database';
import { AppShellRoot, buildAppPath, MODERN_APP_ROOT } from '@/features/inspiration/lib/app-shell';
...
export default function IdeaDetailClient({
    ...
    const handleDelete = () => {
        ...
        startTransition(async () => {
            ...
            router.push(buildAppPath(appRoot, '/ideas'));
        });
    };
    ...
    const handleMoveToPlan = () => {
        startTransition(async () => {
            try {
                ...
                router.push(buildAppPath(appRoot, '/planning'));
            } catch (error) {
