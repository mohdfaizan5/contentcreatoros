...
import { createIdea } from '@/features/(legacy)/ideas/actions/ideas';
import { buildAppPath, LEGACY_APP_ROOT } from '@/features/inspiration/lib/app-shell';
import type { EditorJSData } from '@/shared/types/database';
    ...
    const handleSubmit = () => {
        ...
        startTransition(async () => {
            try {
                ...
                router.push(buildAppPath(LEGACY_APP_ROOT, '/ideas'));
            } catch (error) {
