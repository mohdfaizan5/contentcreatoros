...
import { PlaceholderList } from '@/features/(legacy)/templates/components/placeholder-renderer';
import { PlatformPreview } from '@/features/(legacy)/templates/components/platform-preview';
...
export default function CreateTemplatePage() {
    ...
    const handleSubmit = () => {
        ...
        startTransition(async () => {
            try {
                ...
                router.push(buildAppPath(LEGACY_APP_ROOT, '/templates'));
            } catch (error) {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6 animate-fade-in-up">
            {/* Back navigation */}
            <Link
                href={buildAppPath(LEGACY_APP_ROOT, '/templates')}
