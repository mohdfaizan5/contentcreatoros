...
import { ArrowLeft, SpinnerGap, Download, ArrowSquareOut, Article } from '@phosphor-icons/react';
import Link from 'next/link';
import { Button } from '@/shared/components/ui/button';
import { AutoResizeTextarea } from '@/shared/components/ui/auto-resize-textarea';
import { createMagnet } from '@/features/(legacy)/lead-magnets/actions/lead-magnets';
import { buildAppPath, LEGACY_APP_ROOT } from '@/features/inspiration/lib/app-shell';
import type { DeliveryType } from '@/shared/types/database';
...
export default function CreateLeadMagnetPage() {
    ...
    const handleSubmit = () => {
        ...
        startTransition(async () => {
            try {
                ...
                router.push(buildAppPath(LEGACY_APP_ROOT, '/lead-magnets'));
            } catch (error) {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6 animate-fade-in-up">
            {/* Back navigation */}
            <Link
                href={buildAppPath(LEGACY_APP_ROOT, '/lead-magnets')}
