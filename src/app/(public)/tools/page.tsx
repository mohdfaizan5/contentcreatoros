...
export const metadata: Metadata = {
  ...
  description:
    "Utility tools for previewing and refining content before it goes live.",
};

const tools = [
  {
    href: "/tools/twitter-preview",
    ...
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 pb-10">
      <section className=" py-8">
        ...
        <h1 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
          Content tools that help before you publish.
        </h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">
          Small focused tools live here. Right now you’ve got a dedicated X post
          visualizer for checking copy and media before the real post goes out.
        </p>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {tools.map((tool) => (
          <Card
            key={tool.href}
            className="border-border/70 transition-transform duration-300 hover:-translate-y-1"
          >
            <CardHeader>
