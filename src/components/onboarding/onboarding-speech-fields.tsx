...
export function OnboardingWebsiteSearchInput({
  ...
  return (
    <FaviconSearch
      ...
      placeholder={placeholder}
      className={className}
      inputClassName="h-12 rounded-md border-slate-200 bg-white"
      clearable
    />
  );
}
      ...
      {profile ? (
        <div className="rounded-md border border-slate-200 bg-white px-3 py-2">
          ...
          <div className="mt-2 grid grid-cols-3 gap-2 text-xs text-slate-600">
            <div>
              <p className="font-semibold text-slate-900">{formatMetric(profile.followersCount)}</p>
              <p>Followers</p>
            </div>
            <div>
              <p className="font-semibold text-slate-900">{formatMetric(profile.followingCount)}</p>
              <p>Following</p>
            </div>
            <div>
              <p className="font-semibold text-slate-900">{formatMetric(profile.tweetCount)}</p>
              <p>Posts</p>
            </div>
          </div>
        </div>
