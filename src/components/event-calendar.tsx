...
import { ArrowDownIcon, ArrowRightIcon, PlusIcon, ArrowLeftIcon } from "@phosphor-icons/react/dist/ssr";
    ...
    >
      <CalendarDndProvider onEventUpdate={readOnly ? undefined : handleEventUpdate}>
        ...
        <EventDialog
          key={
            selectedEvent
              ? `${selectedEvent.id || "new"}-${selectedEvent.start.toISOString()}-${selectedEvent.end.toISOString()}`
              : "event-dialog-closed"
          }
          event={selectedEvent}
