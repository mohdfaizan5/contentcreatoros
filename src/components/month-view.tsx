...
export function MonthView({
  ...
  const { contentHeight, contentRef, getVisibleEventCount } = useEventVisibility({
    eventGap: EventGap,
        ...
        {weeks.map((week, weekIndex) => (
          ...
          >
            {week.map((day, dayIndex) => {
              ...
              const hasMeasuredContent = contentHeight !== null;
              const visibleCount = hasMeasuredContent
                  ...
                  >
                    ...
                    >
                      {sortEvents(allDayEvents).map((event, index) => {
                        ...
                        const isHidden =
                          hasMeasuredContent && index >= visibleCount;
