...
import { useMediaQuery } from "@/features/(public)/pricing/hooks/use-media-query";
...
export function SidebarMenuButton({
  ...
  if (asChild && !render && React.isValidElement(props.children)) {
    const child = props.children as React.ReactElement<{ children?: React.ReactNode }>;
    resolvedRender = child as React.ReactElement<Record<string, unknown>>;
