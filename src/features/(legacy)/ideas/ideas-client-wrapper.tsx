...
import { IdeaCard, IdeasList } from '@/features/(legacy)/ideas/idea-card';
import type { Idea } from '@/shared/types/database';
import { AppShellRoot, MODERN_APP_ROOT } from '@/features/inspiration/lib/app-shell';
