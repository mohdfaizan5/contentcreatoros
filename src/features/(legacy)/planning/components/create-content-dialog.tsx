...
import { createContentCard } from '@/features/(legacy)/planning/actions/planning';
import { getIdeas } from '@/features/(legacy)/ideas/actions/ideas';
...
import type { Idea, Series } from '@/shared/types/database';
