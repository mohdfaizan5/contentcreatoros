...
import { detectEmbedType, generateId } from '@/features/templates/lib/template-utils';
import { SocialEmbed } from './social-embed';
import type { PlatformType, TemplateExample, TemplateReference } from '@/shared/types/database';
