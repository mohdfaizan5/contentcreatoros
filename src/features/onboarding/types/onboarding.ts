...
export type OnboardingQuestionLayout = 'cards' | 'pills';
export type OnboardingScreenVariant = 'entry';
...
interface OnboardingSelectQuestionBase extends OnboardingQuestionBase {
  options: OnboardingOption[];
  layout?: OnboardingQuestionLayout;
  otherOption?: OnboardingOtherOptionConfig;
}

export interface OnboardingSingleSelectQuestion extends OnboardingSelectQuestionBase {
  type: 'single-select';
}

export interface OnboardingMultiSelectQuestion extends OnboardingSelectQuestionBase {
  type: 'multi-select';
  minSelections?: number;
  maxSelections?: number;
}

export interface OnboardingTagInputQuestion extends OnboardingQuestionBase {
  type: 'tag-input';
  placeholder?: string;
  maxItems?: number;
}
...
export type OnboardingQuestion =
  ...
  | OnboardingSingleSelectQuestion
  | OnboardingMultiSelectQuestion
  | OnboardingTagInputQuestion;

export interface OnboardingScreenContent {
  variant: OnboardingScreenVariant;
  ctaLabel: string;
...
export interface OnboardingQuestionStepDefinition extends OnboardingStepBase {
  kind: 'questions';
  questions: OnboardingQuestion[];
}

export interface OnboardingScreenStepDefinition extends OnboardingStepBase {
  kind: 'screen';
  screen: OnboardingScreenContent;
}
