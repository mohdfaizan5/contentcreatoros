...
import { runOnboardingAutofill } from '@/features/onboarding/actions/onboarding-autofill';
import {
  VerticalStepperExample,
  type VerticalStepperStep,
} from '@/features/onboarding/components/vertical-stepper-example';
import { saveOnboarding } from '@/features/onboarding/actions/onboarding';
import {
...
} from '@/features/onboarding/lib/flow-view-model';
import {
  buildOptionsWithOther,
  shouldShowOtherInput,
} from '@/features/onboarding/lib/question-ui-utils';
import {
  getActiveMilestoneStep,
  ONBOARDING_IMPORTANT_MILESTONES,
} from '@/features/onboarding/lib/visual-flow';
import type {
  OnboardingAnswers,
  OnboardingOption,
  OnboardingQuestion,
...
import { useOptionClickSound } from '@/features/onboarding/hooks/use-option-click-sound';
...
import { BrandVisualOverview } from '@/features/brand-kit/components/brand-visual-overview';
