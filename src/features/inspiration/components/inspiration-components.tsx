...
import { createInspiration, deleteInspiration } from '@/features/inspiration/actions/inspiration';
import { detectUrlInfo, getPlatformColors, extractTweetId, type Platform } from '@/features/inspiration/lib/url-detector';
import type { Inspiration, InspirationType } from '@/shared/types/database';
